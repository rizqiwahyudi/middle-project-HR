                ...
                <div class="col-sm-5">
                    <div class="user-area dropdown float-right">
                        ...
                        <div class="user-menu dropdown-menu">
                                <a class="nav-link" href="{{route('show.user', [Auth::user()->id])}}"><i class="fa fa- user"></i>My Profile</a>

                                <a class="nav-link" href="{{route('edit.user', [Auth::user()->id])}}"><i class="fa fa -cog"></i>Settings</a>
