                ...
                <div class="card-body">
                    <form method="POST" action="{{route('update.user', [$user->id])}}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="telepon" type="text" class="form-control @error('telepon') is-invalid @enderror" name="telepon" value="{{ $user->telepon }}" required autocomplete="telepon" autofocus>
                        ...
                        <div class="form-group row pt-4">
                            <label for="select_role" class="col-md-4 col-form-label text-md-right">{{ __('Select Role') }}</label>
