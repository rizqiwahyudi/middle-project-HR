            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{route('departments.update', [$department->id])}}">
                        ...
                        <div class="form-group row">
                            <label for="description" class="col-md-4 col-form-label text-md-right">{{ __('Department Description') }}</label>

                            <div class="col-md-6">
                                <textarea id="description" name="description" class="form-control @error('description') is-invalid @enderror" required rows="5" autofocus autocomplete="description">{{$department->description}}</textarea>
